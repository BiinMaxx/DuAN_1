            ...
            <div class="row mtn-30">
                ...
                <div class="col-sm-6 col-lg-3">
                    <div class="policy-item">
                        ...
                        <div class="policy-content">
                            <h6>Hoàn tiền</h6>
                            <p>Hoàn tiền trong 30 ngày nếu lỗi</p>
                        </div>
                    </div>
                </div>
                <div class="col-sm-6 col-lg-3">
                ...
                <div class="col-sm-6">
                    <figure class="banner-statistics mt-20">
                        ...
                        <div class="banner-content text-right">
                            ...
                            <h2 class="banner-text2">Bộ sưu tập <span>Coza Store</span></h2>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <div class="section-title text-center">
                                            ...
                                            <p class="sub-title">Sản phẩm được cập nhật vào hàng tuần</p>
                                        </div>
                                        <!-- section title start -->
                                    </div>
                                </div>
                                        ...
                                        <div class="product-banner-carousel slick-row-10">
                                            ...
                                            <div class="banner-slide-item">
                                                <figure class="banner-statistics">
                                                    <a href="#">
                                                        <img src="./views/assets/img/banner/img1-middle.jpg"
                                                            alt="product banner">
                                                    </a>
                                            ...
                                            <div class="banner-slide-item">
                                                <figure class="banner-statistics">
                                                    <a href="#">
                                                        <img src="./views/assets/img/banner/img2-middle.jpg"
                                                            alt="product banner">
                                                    </a>
                                                    <div class="banner-content banner-content_style2">
                                            ...
                                            <div class="banner-slide-item">
                                                <figure class="banner-statistics">
                                                    <a href="#">
                                                        <img src="./views/assets/img/banner/img3-middle.jpg"
                                                            alt="product banner">
                                                    </a>
                                                    <div class="banner-content banner-content_style2">
                                            ...
                                            <div class="banner-slide-item">
                                                <figure class="banner-statistics">
                                                    <a href="#">
                                                        <img src="./views/assets/img/banner/img4-middle.jpg"
                                                            alt="product banner">
                                                    </a>
                                                    <div class="banner-content banner-content_style2">
                                            ...
                                            <div class="banner-slide-item">
                                                <figure class="banner-statistics">
                                                    <a href="#">
                                                        <img src="./views/assets/img/banner/img5-middle.jpg"
                                                            alt="product banner">
                                                    </a>
                                                    <div class="banner-content banner-content_style2">
                                        ...
                                        <div class="product-carousel-4_2 slick-row-10 slick-arrow-style">
                                            ...
                                            <div class="product-item">
                                                <figure class="product-thumb">
                                                    <a href="product-details.html">
                                                        <img class="pri-img"
                                                            src="./views/assets/img/product/product-6.jpg"
                                                            alt="product">
                                                        <img class="sec-img"
                                                            src="./views/assets/img/product/product-13.jpg"
                                                            alt="product">
                                                    </a>
                                                    <div class="product-badge">
                                                        <div class="product-label new">
                                            ...
                                            <div class="product-item">
                                                <figure class="product-thumb">
                                                    <a href="product-details.html">
                                                        <img class="pri-img"
                                                            src="./views/assets/img/product/product-7.jpg"
                                                            alt="product">
                                                        <img class="sec-img"
                                                            src="./views/assets/img/product/product-9.jpg"
                                                            alt="product">
                                                    </a>
                                                    <div class="product-badge">
                                                        <div class="product-label new">
                                            ...
                                            <div class="product-item">
                                                <figure class="product-thumb">
                                                    <a href="product-details.html">
                                                        <img class="pri-img"
                                                            src="./views/assets/img/product/product-8.jpg"
                                                            alt="product">
                                                        <img class="sec-img"
                                                            src="./views/assets/img/product/product-11.jpg"
                                                            alt="product">
                                                    </a>
                                                    <div class="product-badge">
                                                        <div class="product-label new">
                                            ...
                                            <div class="product-item">
                                                <figure class="product-thumb">
                                                    <a href="product-details.html">
                                                        <img class="pri-img"
                                                            src="./views/assets/img/product/product-16.jpg"
                                                            alt="product">
                                                        <img class="sec-img"
                                                            src="./views/assets/img/product/product-10.jpg"
                                                            alt="product">
                                                    </a>
                                                    <div class="product-badge">
                                                        <div class="product-label new">
                                            ...
                                            <div class="product-item">
                                                <figure class="product-thumb">
                                                    <a href="product-details.html">
                                                        <img class="pri-img"
                                                            src="./views/assets/img/product/product-1.jpg"
                                                            alt="product">
                                                        <img class="sec-img"
                                                            src="./views/assets/img/product/product-18.jpg"
                                                            alt="product">
                                                    </a>
                                                    <div class="product-badge">
                                                        <div class="product-label new">
                                            ...
                                            <div class="product-item">
                                                <figure class="product-thumb">
                                                    <a href="product-details.html">
                                                        <img class="pri-img"
                                                            src="./views/assets/img/product/product-2.jpg"
                                                            alt="product">
                                                        <img class="sec-img"
                                                            src="./views/assets/img/product/product-17.jpg"
                                                            alt="product">
                                                    </a>
                                                    <div class="product-badge">
                                                        <div class="product-label new">
                                            ...
                                            <div class="product-item">
                                                <figure class="product-thumb">
                                                    <a href="product-details.html">
                                                        <img class="pri-img"
                                                            src="./views/assets/img/product/product-3.jpg"
                                                            alt="product">
                                                        <img class="sec-img"
                                                            src="./views/assets/img/product/product-16.jpg"
                                                            alt="product">
                                            ...
                                            <div class="product-item">
                                                <figure class="product-thumb">
                                                    <a href="product-details.html">
                                                        <img class="pri-img"
                                                            src="./views/assets/img/product/product-4.jpg"
                                                            alt="product">
                                                        <img class="sec-img"
                                                            src="./views/assets/img/product/product-15.jpg"
                                                            alt="product">
                                                    </a>
                                                    <div class="product-badge">
                                                        <div class="product-label new">
                                            ...
                                            <div class="product-item">
                                                <figure class="product-thumb">
                                                    <a href="product-details.html">
                                                        <img class="pri-img"
                                                            src="./views/assets/img/product/product-5.jpg"
                                                            alt="product">
                                                        <img class="sec-img"
                                                            src="./views/assets/img/product/product-14.jpg"
                                                            alt="product">
                                                    </a>
                                                    <div class="product-badge">
                                                        <div class="product-label new">
                                        ...
                                        <div class="testimonial-thumb-wrapper">
                                            <div class="testimonial-thumb-carousel">
                                                <div class="testimonial-thumb">
                                                    <img src="./views/assets/img/testimonial/testimonial-1.png"
                                                        alt="testimonial-thumb">
                                                </div>
                                                <div class="testimonial-thumb">
                                                    <img src="./views/assets/img/testimonial/testimonial-2.png"
                                                        alt="testimonial-thumb">
                                                </div>
                                                <div class="testimonial-thumb">
                                                    <img src="./views/assets/img/testimonial/testimonial-3.png"
                                                        alt="testimonial-thumb">
                                                </div>
                                                <div class="testimonial-thumb">
                                                    <img src="./views/assets/img/testimonial/testimonial-2.png"
                                        ...
                                        <div class="testimonial-content-wrapper">
                                            <div class="testimonial-content-carousel">
                                                <div class="testimonial-content">
                                                    <p>Vivamus a lobortis ipsum, vel condimentum magna. Etiam id turpis
                                                        tortor. Nunc
                                                        scelerisque, nisi a blandit varius, nunc purus venenatis ligula,
                                                        sed venenatis orci
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="group-product-banner">
                                            <figure class="banner-statistics">
                                                <a href="#">
                                                    <img src="./views/assets/img/banner/img-bottom-banner.jpg"
                                                        alt="product banner">
                                                </a>
                                                ...
                                                <div class="group-list-carousel">
                                                    ...
                                                    <div class="group-slide-item">
                                                        <div class="group-item">
                                                            <div class="group-item-thumb">
                                                                <a href="product-details.html">
                                                                    <img src="./views/assets/img/product/product-1.jpg"
                                                                        alt="">
                                                                </a>
                                                            </div>
                                                    ...
                                                    <div class="group-slide-item">
                                                        <div class="group-item">
                                                            <div class="group-item-thumb">
                                                                <a href="product-details.html">
                                                                    <img src="./views/assets/img/product/product-3.jpg"
                                                                        alt="">
                                                                </a>
                                                            </div>
                                                            <div class="group-item-desc">
                                                    ...
                                                    <div class="group-slide-item">
                                                        <div class="group-item">
                                                            <div class="group-item-thumb">
                                                                <a href="product-details.html">
                                                                    <img src="./views/assets/img/product/product-5.jpg"
                                                                        alt="">
                                                                </a>
                                                            </div>
                                                            <div class="group-item-desc">
                                                    ...
                                                    <div class="group-slide-item">
                                                        <div class="group-item">
                                                            <div class="group-item-thumb">
                                                                <a href="product-details.html">
                                                                    <img src="./views/assets/img/product/product-7.jpg"
                                                                        alt="">
                                                                </a>
                                                            </div>
                                                            <div class="group-item-desc">
                                                    ...
                                                    <div class="group-slide-item">
                                                        <div class="group-item">
                                                            <div class="group-item-thumb">
                                                                <a href="product-details.html">
                                                                    <img src="./views/assets/img/product/product-9.jpg"
                                                                        alt="">
                                                                </a>
                                                            </div>
                                                            <div class="group-item-desc">
                                                    ...
                                                    <div class="group-slide-item">
                                                        <div class="group-item">
                                                            <div class="group-item-thumb">
                                                                <a href="product-details.html">
                                                                    <img src="./views/assets/img/product/product-11.jpg"
                                                                        alt="">
                                                                </a>
                                                            </div>
                                                            <div class="group-item-desc">
                                                    ...
                                                    <div class="group-slide-item">
                                                        <div class="group-item">
                                                            <div class="group-item-thumb">
                                                                <a href="product-details.html">
                                                                    <img src="./views/assets/img/product/product-13.jpg"
                                                                        alt="">
                                                                </a>
                                                            </div>
                                                            <div class="group-item-desc">
                                                    ...
                                                    <div class="group-slide-item">
                                                        <div class="group-item">
                                                            <div class="group-item-thumb">
                                                                <a href="product-details.html">
                                                                    <img src="./views/assets/img/product/product-15.jpg"
                                                                        alt="">
                                                                </a>
                                                            </div>
                                                            <div class="group-item-desc">
                                                ...
                                                <div class="group-list-carousel">
                                                    ...
                                                    <div class="group-slide-item">
                                                        <div class="group-item">
                                                            <div class="group-item-thumb">
                                                                <a href="product-details.html">
                                                                    <img src="./views/assets/img/product/product-17.jpg"
                                                                        alt="">
                                                                </a>
                                                            </div>
                                                            <div class="group-item-desc">
                                                    ...
                                                    <div class="group-slide-item">
                                                        <div class="group-item">
                                                            <div class="group-item-thumb">
                                                                <a href="product-details.html">
                                                                    <img src="./views/assets/img/product/product-16.jpg"
                                                                        alt="">
                                                                </a>
                                                            </div>
                                                            <div class="group-item-desc">
                                                    ...
                                                    <div class="group-slide-item">
                                                        <div class="group-item">
                                                            <div class="group-item-thumb">
                                                                <a href="product-details.html">
                                                                    <img src="./views/assets/img/product/product-12.jpg"
                                                                        alt="">
                                                                </a>
                                                            </div>
                                                            <div class="group-item-desc">
                                                    ...
                                                    <div class="group-slide-item">
                                                        <div class="group-item">
                                                            <div class="group-item-thumb">
                                                                <a href="product-details.html">
                                                                    <img src="./views/assets/img/product/product-2.jpg"
                                                                        alt="">
                                                                </a>
                                                            </div>
                                                            <div class="group-item-desc">
                                                    ...
                                                    <div class="group-slide-item">
                                                        <div class="group-item">
                                                            <div class="group-item-thumb">
                                                                <a href="product-details.html">
                                                                    <img src="./views/assets/img/product/product-18.jpg"
                                                                        alt="">
                                                                </a>
                                                            </div>
                                                            <div class="group-item-desc">
                                                    ...
                                                    <div class="group-slide-item">
                                                        <div class="group-item">
                                                            <div class="group-item-thumb">
                                                                <a href="product-details.html">
                                                                    <img src="./views/assets/img/product/product-14.jpg"
                                                                        alt="">
                                                                </a>
                                                            </div>
                                                            <div class="group-item-desc">
                                    ...
                                    <div class="col-12">
                                        <div class="blog-carousel-active slick-row-10 slick-arrow-style">
                                            ...
                                            <div class="blog-post-item">
                                                <figure class="blog-thumb">
                                                    <a href="blog-details.html">
                                                        <img src="./views/assets/img/blog/blog-img1.jpg"
                                                            alt="blog image">
                                                    </a>
                                                </figure>
                                            ...
                                            <div class="blog-post-item">
                                                <figure class="blog-thumb">
                                                    <a href="blog-details.html">
                                                        <img src="./views/assets/img/blog/blog-img2.jpg"
                                                            alt="blog image">
                                                    </a>
                                                </figure>
                                                <div class="blog-content">
                                                    ...
                                                    <h5 class="blog-title">
                                                        <a href="blog-details.html">Children Left Home Alone For 4 Days
                                                            In TV series
                                                            Experiment</a>
                                                    </h5>
                                                </div>
                                            ...
                                            <div class="blog-post-item">
                                                <figure class="blog-thumb">
                                                    <a href="blog-details.html">
                                                        <img src="./views/assets/img/blog/blog-img3.jpg"
                                                            alt="blog image">
                                                    </a>
                                                </figure>
                                                <div class="blog-content">
                                                    ...
                                                    <h5 class="blog-title">
                                                        <a href="blog-details.html">Lotto Winner Offering Up Money To
                                                            Any Man That Will Date
                                                            Her</a>
                                                    </h5>
                                                </div>
                                            </div>
                                            ...
                                            <div class="blog-post-item">
                                                <figure class="blog-thumb">
                                                    <a href="blog-details.html">
                                                        <img src="./views/assets/img/blog/blog-img4.jpg"
                                                            alt="blog image">
                                                    </a>
                                                </figure>
                                                <div class="blog-content">
                                                    ...
                                                    <h5 class="blog-title">
                                                        <a href="blog-details.html">People are Willing Lie When Comes
                                                            Money, According to
                                                            Research</a>
                                                    </h5>
                                                </div>
                                            ...
                                            <div class="blog-post-item">
                                                <figure class="blog-thumb">
                                                    <a href="blog-details.html">
                                                        <img src="./views/assets/img/blog/blog-img5.jpg"
                                                            alt="blog image">
                                                    </a>
                                                </figure>
                                                <div class="blog-content">
