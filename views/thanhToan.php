                        ...
                        <div class="checkout-billing-details-wrap">
                            ...
                            <div class="billing-form-wrap">
                                ...
                                <div class="single-input-item">
                                    ...
                                    <input type="ten_nguoi_nhan" id="sdt_nguoi_nhan" name="sdt_nguoi_nhan"
                                ...
                                <div class="single-input-item">
                                    ...
                                    <input type="dia_chi_nguoi_nhan" id="dia_chi_nguoi_nhan" name="dia_chi_nguoi_nhan"
                                ...
                                <div class="single-input-item">
                                    ...
                                    <textarea name="ghi_chu" id="ghi_chu" cols="30" rows="3"
                                        placeholder="Nhập ghi chú với đơn hàng của bạn."></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tfoot>
                                            ...
                                            <tr>
                                                ...
                                                <td><strong><?= formatPrice($tongGioHang + 30000) . '.Vnđ'; ?></strong>
                                                </td>
                                            </tr>
                                        </tfoot>
                                    </table>
                                        ...
                                        <div class="payment-method-name">
                                            <div class="custom-control custom-radio">
                                                <input type="radio" id="cashon"  value="1"
                                                    class="custom-control-input" name="phuong_thuc_thanh_toan_id" checked />
                                                <label class="custom-control-label" for="cashon">Thanh toán khi nhận
                                                    hàng</label>
                                            </div>
                                        </div>
                                        <div class="payment-method-details" data-method="cash">
                                            <p>Khách hàng có thể thanh toán sau khi nhận hàng
                                            </p>
                                        </div>
                                    </div>
                                        ...
                                        <div class="payment-method-name">
                                            <div class="custom-control custom-radio">
                                                <input type="radio" id="directbank" value="2"
                                                    class="custom-control-input" name="phuong_thuc_thanh_toan_id" />
